...
cat.sendData=function(req,res,body){
	if(!appConfig['BIServer'])
		return;
	...
	axios.post(appConfig['BIServer'], {
		client_request: reqStr,
		client_response: resStr,
	...
	.catch(function(error) {
		console.log('Error! cannot send log to BI: ' + appConfig['BIServer']);
	});
